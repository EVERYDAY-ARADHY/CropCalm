...
function MenuItem({ link, text, image, speed, textColor, marqueeBgColor, marqueeTextColor, borderColor, onClick }) {
  ...
  return (
    <div className="menu__item" ref={itemRef} style={{ borderColor }}>
      <button
        className="menu__item-link font-heading bg-transparent border-none w-full outline-none"
        onClick={onClick}
      ...
      <div className="marquee" ref={marqueeRef} style={{ backgroundColor: marqueeBgColor }}>
        <div className="marquee__inner-wrap">
          <div className="marquee__inner font-heading" ref={marqueeInnerRef} aria-hidden="true">
